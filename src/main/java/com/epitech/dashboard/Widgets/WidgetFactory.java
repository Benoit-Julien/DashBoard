...
public class WidgetFactory {
    ...
    private WidgetFactory() {
        ...
        try {
            ...
            widgets.put("Nombre d'abonnes (YT)", Class.forName("com.epitech.dashboard.Widgets.SubscribersWidget"));
            ...
            widgets.put("SubReddit post", Class.forName("com.epitech.dashboard.Widgets.RedditWidget"));
